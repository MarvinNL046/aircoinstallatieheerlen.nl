      ...
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <p className="text-muted-foreground mb-8">
            This page tests the contact form submission system (EmailJS + LeadFlow CRM).
          </p>

          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
            <h3 className="font-semibold text-blue-900 mb-2">Test Features:</h3>
            <ul className="list-disc list-inside text-blue-800 text-sm space-y-1">
              <li>EmailJS email notification</li>
              <li>LeadFlow CRM lead capture</li>
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded">
              ...
              <ol className="list-decimal list-inside text-sm text-gray-700 space-y-1">
                ...
                <li>sendEmail() submits to both EmailJS and LeadFlow in parallel</li>
            ...
            <div className="bg-gray-50 p-4 rounded">
              ...
              <ul className="list-disc list-inside text-sm text-gray-700 mt-2 space-y-1">
                <li>Starting submission</li>
                <li>EmailJS and LeadFlow status</li>
